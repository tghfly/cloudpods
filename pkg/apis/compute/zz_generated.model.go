...
// SBaremetalStorageMount is an autogenerated struct via yunion.io/x/onecloud/pkg/compute/models.SBaremetalStorageMount.
...
// SIpSet is an autogenerated struct via yunion.io/x/onecloud/pkg/compute/models.SIpSet.
type SIpSet struct {
	apis.SSharableVirtualResourceBase
	// IP集合类型
	IpSetType string `json:"ip_set_type"`
	// IP/CIDR 列表，逗号分隔
...
type SServerSku struct {
	...
	// 磁盘性能数据
	DiskPerformance string `json:"disk_performance"`
	NicType         string `json:"nic_type"`
	NicMaxCount     int    `json:"nic_max_count"`
	// 内网带宽
	NicBandwidth  string `json:"nic_bandwidth"`
